...
#pragma region Stage Scene
    IMAGEMANAGER->addImage("오프닝 픽셀", "Resources/Images/BackGround/openingScenePixel.bmp", 4150, 1694, MGT);
	...
	//IMAGEMANAGER->addImage("오프닝씬 픽셀", "Resources/Images/BackGround/openingScenePixel.bmp", WINSIZE_X * 2, WINSIZE_Y);// MGT);
...
#pragma region UI Object
	...
	// Object
    IMAGEMANAGER->addImage("버튼", "Resources/Images/Object/buttomE.bmp", 35 * 1.9, 38 * 1.9, MGT);
