...
#pragma region PlayerImage
	...
	IMAGEMANAGER->addFrameImage("꼬깔기상", "Resources/Images/Player/p_risingFromFallen.bmp", 896, 768, 7, 6, MGT);
...
#pragma region Stage Scene
    IMAGEMANAGER->addImage("오프닝씬 바닥", "Resources/Images/BackGround/openingScenefloor.bmp", 4150 * 0.5, 1694 * 0.5, MGT);
    IMAGEMANAGER->addImage("오프닝씬 테스트배경", "Resources/Images/BackGround/openingSceneAll.bmp", 4150 * 0.5, 1694 * 0.5);
    IMAGEMANAGER->addImage("오프닝씬 뒷배경", "Resources/Images/BackGround/openingSceneLastBG.bmp", 4150 * 0.5, 1694 * 0.5);
    IMAGEMANAGER->addImage("오프닝씬 앞시체", "Resources/Images/BackGround/openingSceneFrontBody.bmp", 4150 * 0.5, 1694 * 0.5, MGT);
    IMAGEMANAGER->addImage("오프닝씬 앞문", "Resources/Images/BackGround/openingSceneFrontDoor.bmp", 4150 * 0.5, 1694 * 0.5, MGT);
	IMAGEMANAGER->addImage("오프닝씬 픽셀", "Resources/Images/BackGround/openingScenePixel.bmp", 4150 * 0.5, 1694 * 0.5, MGT);
