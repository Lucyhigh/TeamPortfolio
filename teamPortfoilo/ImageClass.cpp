...
#pragma region Stage Scene
	...
	IMAGEMANAGER->addImage("엔딩씬 바닥", "Resources/Images/BackGround/endingfloor.bmp", 4150, 1694, MGT);
	IMAGEMANAGER->addImage("엔딩씬 테스트배경", "Resources/Images/BackGround/endingAll.bmp", 4150, 1694);//
	IMAGEMANAGER->addImage("엔딩씬 뒷배경", "Resources/Images/BackGround/endingBG.bmp", 4150, 1694);
	IMAGEMANAGER->addImage("엔딩씬 앞배경", "Resources/Images/BackGround/endingFG.bmp", 4150, 1694, MGT);
	IMAGEMANAGER->addImage("엔딩씬 픽셀", "Resources/Images/BackGround/endingScenePixel.bmp", 4150, 1694, MGT);
