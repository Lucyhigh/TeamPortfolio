...
#pragma region PlayerImage
	...
	IMAGEMANAGER->addFrameImage("꼬깔점프", "Resources/Images/Player/p_jump.bmp", 1120*1.9, 158*1.9, 14, 2, MGT);
	IMAGEMANAGER->addFrameImage("꼬깔슬라이드", "Resources/Images/Player/p_slide.bmp", 1455 * 1.9, 144 * 1.9, 15, 2, MGT);
#pragma endregion
