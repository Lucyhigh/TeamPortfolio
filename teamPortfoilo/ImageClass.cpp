...
#pragma region PlayerImage
	...
	IMAGEMANAGER->addFrameImage("꼬깔대기P", "Resources/Images/Player/p_idle.bmp", 1664 * 2, 146 * 2, 13, 2, MGT);
	IMAGEMANAGER->addFrameImage("꼬깔이동P", "Resources/Images/Player/p_move.bmp", 1106 * 2, 140 * 2, 14, 2, MGT);
	...
	IMAGEMANAGER->addFrameImage("꼬깔기상", "Resources/Images/Player/p_risingFromFallen.bmp", 896 * 2, 768 * 2, 7, 6, MGT);
